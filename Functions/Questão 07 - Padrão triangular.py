"""O programa a seguir deveria imprimir 8 linhas exibindo um padrão visualmente triangular usando-se apenas as
instruções e outros recursos que aprendemos até agora. Corrija os erros de sintaxe e de lógica para que ele imprima o
...
imprime_padrão()A Entrada consiste de:
