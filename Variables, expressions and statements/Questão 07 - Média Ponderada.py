...
No terceiro exemplo, a nota 9.1 tem peso 1, a nota 5.1 tem peso 2 e a nota 5.1 tem peso 3. Então a média ponderada
resultante é 5.766667.
Dica:
...
soma_peso = p1 + p2 + p3
media = ((p1*n1 + p2*n2 + p3*n3) / soma_peso)
